...
Package components:
1. Settings (`conftest`): Settings and configurations for tests, including environment parameters
and other configuration data.
2. Factories (`factories`): Module for creating a fake database that can be used in tests to isolate
the application from the real database.
